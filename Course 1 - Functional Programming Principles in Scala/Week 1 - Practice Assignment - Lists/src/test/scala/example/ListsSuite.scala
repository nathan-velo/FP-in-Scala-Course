...
class ListsSuite extends munit.FunSuite:
  ...
  test("sum of a few negative numbers") {
    assertEquals(sum(List(-3,-2,-7)), -12)
  }

  test("max of a few negative number") {
    assertEquals(max(List(-3,-2,-7)),-2)
  }

  test("max of zeros") {
    assertEquals(max(List(0,0,0,0)), 0)
  }

  test("sum of zeros") {
    assertEquals(sum(List(0,0,0,0)), 0)
  }
  ...
  test("max of list with same values") {
    assertEquals(max(List(5,5,5,5,5)),5)
  }

  test("sum of list with same values") {
    assertEquals(sum(List(5,5,5,5,5)),25)
  }
